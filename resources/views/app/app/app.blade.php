...
<head>
    ...
    <style>
        ...
        .btn-x{
            background-color: #4BA992 !important;
            color : #fff !important;
        }
        .btn-outline-primary{
            color: #4BA992;
...
<body style="padding: 0; margin: 0;">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light position-fixed">
        <div class="container">
            <a class="navbar-brand me-2" href="/"><img src="{{ URL('images1/logo.png') }}" height="35" alt="AST Sports"
                    loading="lazy"></a>
                ...
                <form action="/tim-kiem" method="POST"
                    ...
                    <div class="input-group" style="width:170px;">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-primary btn-x" type="submit">
            ...
            <div class="collapse navbar-collapse" id="navbarButtons">
                ...
                <div class="d-flex align-items-center float-right">
                    <a href="/"><button type="button" class="btn btn-link px-3 me-2 cl">TRANG CHỦ</button></a>
                    <a href="/cua-hang"><button type="button" class="btn btn-link px-3 me-2 cl">CỬA HÀNG</button></a>
                    <a href="/gioi-thieu"><button type="button" class="btn btn-link px-3 me-2 cl">GIỚI
                            THIỆU</button></a>
                    <a href="/thanh-toan"><button type="button" class="btn btn-link px-3 me-2 cl">THANH
                            TOÁN</button></a>
                ...
                <!-- <a href="{{ url('/RestaurantManager/User/trangchu') }}" class="btn btn-primary btn-rounded">CỬA HÀNG CỦA BẠN</a> -->
                        @else
                            ...
                            @if (Route::has('register'))
                                <a class="btn btn-rounded btn-x" href="{{ route('auth.register') }}">ĐĂNG KÝ MIỄN PHÍ</a>
                            @endif
                        @endauth
                    @endif --}}
                    ...
                    {{-- <a class="btn btn-outline-primary btn-rounded" href="{{ route('auth.login') }}">ĐĂNG NHẬP</a>
                    &ensp;
                <a class="btn btn-x btn-rounded" href="{{ route('auth.register') }}">ĐĂNG KÝ MIỄN PHÍ</a> --}}
                    ...
                    @else
                        <a class="btn btn-outline-primary btn-rounded" href="{{ route('auth.login') }}">ĐĂNG
                            NHẬP</a>
                        &ensp;
                        <a class="btn btn-x btn-rounded" href="{{ route('auth.register') }}">ĐĂNG KÝ MIỄN
                            PHÍ</a>
                    @endif
        ...
        <section class=" justify-content-center justify-content-lg-between p-4 border-top"
            ...
            <div class="text-center me-5 d-none d-lg-block">
                <span class="text-center text-white">© 2021 Bản quyền thuộc về:
                    <a class="text-white" href="/">&ensp;AST Sports </a>
                </span>
            </div>
        </section>
    </footer>
